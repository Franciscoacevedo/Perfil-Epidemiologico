    ...
    public partial class PerfilEpidemiologico : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                                                        ...
                                                        {
                {
                    ...
                    SqlConnection conn = new SqlConnection("Data Source=.\\SQLEXPRESS;DataBase=Francisco;Integrated Security=SSPI");
                    {
                        ...
                        + "','" + checkBox24.Checked + "','" + checkBox23.Checked + "','" + checkBox22.Checked + "','"+dateTimePicker1+ "')";
                        cmd.ExecuteNonQuery();
                        conn.Close();
